...
With EmbedMetrics today, users can ask questions like:

- _"How did revenue compare between Q2 and Q3?"_
- _"Compare this quarter to last quarter"_
- _"What are our top products by revenue this month?"_

And they get **clear visual answers**: bar charts, KPIs, trend lines, tables, and helpful follow-ups that guide users toward deeper insights.

## Why Now

- **AI-native UX is going mainstream**: People expect interfaces they can talk to.
- **Dashboards are at a turning point**: Adoption is low. Context-switching kills usage.
...
All wrapped in a lightweight, embeddable, brandable component.
